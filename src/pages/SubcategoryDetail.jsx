...
const SubcategoryDetail = () => {
    ...
    React.useEffect(() => {
        if (subcategory) {
            document.title = `${subcategory.name} | Blue World Exports - ${product?.name}`;
        }
    }, [subcategory, product]);
    ...
    const subcategoryImageMap = {
        ...
        'pp-rope': [
            ...
            '/images/products/rope/pp/pprope.jpeg',
            '/images/products/rope/pp/Rope2.png',
            '/images/products/rope/pp/pprope2.jpeg'
        ],
        ...
        'construction-scaffold-net': [
            ...
            '/images/products/Shade net/construction/Scaffolding-safety-nets-1.jpg',
            '/images/products/Shade net/construction/Building-Construction-Shade-Net.jpg',
            '/images/products/Shade net/construction/ShadeNet9.png',
            '/images/products/Shade net/construction/ShadeNet10.png'
        ],
        'pp-strap': [
    ...
    const accordions = [
        {
            id: 'features',
            title: 'Key Features',
            content: subcategory.features || ['UV Stabilized for long life', 'High tensile strength', 'Chemical resistant', 'Weatherproof durability']
        },
        {
            id: 'apps',
            title: 'Applications',
            content: subcategory.applications || ['Agriculture & Irrigation', 'Industrial Packaging', 'Construction Sites', 'Logistics & Warehousing']
        },
        {
            id: 'sizes',
            title: 'Available Sizes',
            content: subcategory.sizes || ['Standard industrial sizes', 'Customizable dimensions on order', 'Various thickness options']
        },
        {
            id: 'colours',
            title: 'Colours',
            content: subcategory.colors || ['Blue', 'Black', 'Yellow', 'Custom colors upon request']
        }
    ];
            ...
            <div className="container-custom">
                ...
                <div className="flex flex-col lg:flex-row gap-16 mb-16">
                    ...
                    <div className="lg:w-1/2">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-10 whitespace-pre-line">
                            {subcategory.description || `Premium quality ${subcategory.name.toLowerCase()} designed for maximum performance, durability, and reliability across various applications.`}
                        </p>
                ...
                <div className="mb-24">
                    ...
                    <ProductTable slug={subcategory.slug} />
                </div>

                {/* Primary CTA Section & Catalogue */}
