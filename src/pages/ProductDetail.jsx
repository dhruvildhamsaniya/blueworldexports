...
const ProductDetail = () => {
    ...
    const subcategoryImageMap = {
        ...
        'braided-pipe': '/images/products/pipe/Brided pipe/istockphoto-1220323956-1024x1024.jpg',
        ...
        'construction-scaffold-net': '/images/products/Shade net/construction/Gemini_Generated_Image_axnrytaxnrytaxnr.png',
                            ...
                            >
                                ...
                                <div className="p-8">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 mb-6 line-clamp-2">
                                        High-quality {sub.name.toLowerCase()} for industrial and agricultural applications. Delivering proven strength and reliability.
                                    </p>
